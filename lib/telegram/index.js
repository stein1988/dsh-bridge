...
export class TelegramService extends Platform {
  ...
  async setConfig({ digestIntervalSec, approvalTimeoutSec, maxMessageChars, sendChunkDelayMs, groupAutoApprove, botToken, proxy, agentPreset, cwd, agentProvider, agentModel } = {}) {
