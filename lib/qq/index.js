...
export class QqService extends Platform {
  ...
  /** 更新运行时配置并持久化。 */
  async setConfig({ digestIntervalSec, approvalTimeoutSec, maxMessageChars, sendChunkDelayMs, groupAutoApprove, appId, clientSecret, agentPreset, cwd, agentProvider, agentModel } = {}) {
